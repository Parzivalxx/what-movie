...
class TestUsersBlueprint(BaseTestCase):
    def test_read_user_success(self):
        ...
        expected_user["registered_on"] = expected_user["registered_on"].strftime("%a, %d %b %Y %H:%M:%S GMT")
    ...
    def test_list_users_success_users_exist(self):
        ...
        user_1["registered_on"] = user_1["registered_on"].strftime("%a, %d %b %Y %H:%M:%S GMT")
        user_2["registered_on"] = user_2["registered_on"].strftime("%a, %d %b %Y %H:%M:%S GMT")
